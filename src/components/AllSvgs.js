...
export const Email = (props) => {
  return (
    ...
    >
      <path
        fill={props.fill}
        d="M502.3 190.8L327.4 338c-15.6 13.4-38.2 21-60.9 21s-45.3-7.6-60.9-21L9.7 190.8C3.9 185.7 0 178.3 0 170.5V144c0-26.5 21.5-48 48-48h416c26.5 0 48 21.5 48 48v26.5c0 7.8-3.9 15.2-9.7 20.3zM0 214.8v197.7c0 26.5 21.5 48 48 48h416c26.5 0 48-21.5 48-48V214.8l-165.6 142c-27.3 23.4-67.5 23.4-94.8 0L0 214.8z"
      />
    </svg>
  )
}
export const LinkedIn = (props) => {
  return (
    ...
    >
      <path
        fill={props.fill}
        d="M100.28 448H7.4V148.9h92.88zm-46.44-341a53.69 53.69 0 1 1 53.69-53.7 53.7 53.7 0 0 1-53.7 53.7zM447.9 448h-92.4V302.4c0-34.7-12.4-58.4-43.3-58.4-23.6 0-37.6 15.9-43.8 31.3-2.2 5.4-2.8 12.9-2.8 20.4V448h-92.4s1.2-269.4 0-297.1h92.4v42.1c12.3-19 34.4-46.1 83.7-46.1 61.1 0 106.9 39.9 106.9 125.6V448z"
      />
    </svg>
  )
}
